...
for arch in architectures:
    print(f"\n==================== TRAINING {arch.upper()} RELATIONNET ====================")
    ...
    # Save encoder and relation module
    encoder.save(f"best_relationnet_{arch}_encoder.keras")
    rel_module.save(f"best_relationnet_{arch}_module.keras")
    ...
    print(f"==> {arch.upper()} RelationNet 5-Shot Holdout Test Accuracy over 100 trials:")
...
np.savez("relationnet_results.npz", **results)
print("\nAll RelationNet architectures trained and saved!")
