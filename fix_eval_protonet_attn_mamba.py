"""Quick fix: Re-evaluate ProtoNet CNN+Attn+Mamba with the correct saved weights."""
import numpy as np
...
# Build model and load the CORRECTLY named weights file
enc = build_cnn_attention_mamba_encoder()
weight_file = "best_opt_protonet_cnn_attention_mamba.keras"  # correct filename
enc.load_weights(weight_file, by_name=True, skip_mismatch=True)
...
print(f"\nProtoNet CNN+Attn+Mamba (CORRECTED holdout):")
